...
**文章和圖片現在放在一起！** 不用再點一堆資料夾了。

```
src/content/articles/
├── _template/              ← 複製這個資料夾來新增文章
│   └── index.md
├── my-new-article/         ← 你的新文章
│   ├── index.md            ← 文章內容
│   ├── cover.jpg           ← 封面圖片
│   └── screenshot.png      ← 文章內的其他圖片（可選）
└── another-article/
    ├── index.md
    └── cover.png
```
...
1. **複製** `_template` 資料夾
2. **重新命名**資料夾（用英文，例如：`my-game-review`）
3. **放入封面圖片**，命名為 `cover.jpg` 或 `cover.png`
4. **編輯** `index.md`
5. **執行** `publish.bat`
